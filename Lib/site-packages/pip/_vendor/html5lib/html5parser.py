    ...
    class InBodyPhase(Phase):
        ...
        def endTagFormatting(self, token):
            ...
            while outerLoopCounter < 8:
                ...
                afeIndex = self.tree.openElements.index0(formattingElement)
                furthestBlock = None
                ...
                bookmark = self.tree.activeFormattingElements.index0(formattingElement)

                # Step 9
                lastNode = node = furthestBlock
                innerLoopCounter = 0

                index = self.tree.openElements.index0(node)
                while innerLoopCounter < 3:
                    ...
                    if lastNode == furthestBlock:
                        bookmark = self.tree.activeFormattingElements.index0(node) + 1
                    # Step 9.8
                    clone = node.cloneNode()
                    # Replace node with clone
                    self.tree.activeFormattingElements[
                        self.tree.activeFormattingElements.index0(node)] = clone
                    self.tree.openElements[
                        self.tree.openElements.index0(node)] = clone
                    node = clone
                    # Step 9.9
                ...
                self.tree.openElements.insert(
                    self.tree.openElements.index0(furthestBlock) + 1, clone)
